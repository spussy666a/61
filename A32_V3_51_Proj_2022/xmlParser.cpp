...
// If you don't need them, you can delete them without any trouble.
    ...
    // for Microsoft Visual Studio 6.0 and Microsoft Visual Studio .NET and Borland C++ Builder 6.0
        ...
        __int64 xmltol(XMLCSTR t,__int64 v){ if (t&&(*t)) return _wtoi64(t); return v; }
        ...
        // for CC
           ...
           __int64 xmltol(XMLCSTR t,__int64 v){ if (t) return wstol(t,NULL,10); return v; }
        #else
        // for gcc
           ...
           __int64 xmltol(XMLCSTR t,__int64 v){ if (t) return wcstol(t,NULL,10); return v; }
        #endif
		double  xmltof(XMLCSTR t,double  v){ if (t&&(*t)) swscanf(t, L"%lf", &v); /*v=_wtof(t);*/ return v; }
    #endif
#else
    #ifdef _XMLWINDOWS
       __int64 xmltol(XMLCSTR t,__int64 v){ if (t&&(*t)) return _atoi64(t); return v; }
    #else
       __int64 xmltol(XMLCSTR t,__int64 v){ if (t&&(*t)) return atoll(t); return v; }
    #endif
